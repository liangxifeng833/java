...
public class AddressServiceImpl implements IAddressService {
    ...
    private static final String BAIDU_MAP_KEY = "5Pv7HcRUBMuYqwmsv8GLB8nwam33fPiC";
    ...
    public ServiceMultiResult<SupportAddressDTO> findAllCities() {
        ...
        //将SupportAddress类型转换为SupportAddressDTO类型,SupportAddressDTO是返回给前端看的内容, 一些敏感信息可以屏蔽掉, 不要把dao返回的结果直接返回
